  ...
  return (
    <div className="min-h-screen bg-white font-sans text-zinc-900">
      ...
      <main className="max-w-7xl mx-auto px-8 py-20 flex flex-col items-center text-center">
        <div className="inline-block px-4 py-1.5 mb-6 text-sm font-medium tracking-wide text-red-400 uppercase bg-red-100 rounded-full">
        MEMORI
        </div>
        ...
        <div className="mt-20 w-full max-w-5xl border border-zinc-200 rounded-2xl overflow-hidden shadow-2xl bg-black">
          <div className="bg-zinc-100 p-4 border-b border-zinc-200 flex gap-2">
